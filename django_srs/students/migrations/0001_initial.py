        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "class_type",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="students.StudentClassInfo"
                    ),
                ),
                (
                    "section_type",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="students.StudentSectionInfo"
                    ),
                ),
                (
                    "shift_type",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="students.StudentShiftInfo"
                    ),
                ),
            ],
        ),
