    ...
    class Meta:
        ...
        widgets = {
            ...
            "admission_date": forms.DateInput(
                attrs={"class": "form-control", "placeholder": "Ex: 2018-12-31", "type": "date"}
            ),
            ...
            "fathers_name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ex: Steve Smith"}
            ),
            "fathers_nid": forms.NumberInput(
                attrs={"class": "form-control", "placeholder": "Ex: 3732106814"}
            ),
            "fathers_number": forms.NumberInput(
                attrs={"class": "form-control", "placeholder": "Ex: 01884334899"}
            ),
            "mothers_name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Ex: Steve Smith"}
            ),
            "mothers_nid": forms.NumberInput(
                attrs={"class": "form-control", "placeholder": "Ex: 3732106814"}
            ),
            "mothers_number": forms.NumberInput(
                attrs={"class": "form-control", "placeholder": "Ex: 01884334899"}
            ),
        }
